...
def save_qualifying_loans(qualifying_loans):
    ...
    save_resluts = questionary.confirm("Would you like to save your qualifiing loans?").ask()
    ...
    if save_resluts and len(qualifying_loans) > 0:
    ...
    elif save_resluts and len(qualifying_loans) == 0:
